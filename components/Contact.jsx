  ...
  return (
    <section className="bg-muted">
      <Container className="flex flex-col lg:flex-row">
        <div className="w-full px-4 py-16 sm:px-6 lg:col-span-2 lg:px-8 xl:pr-12">
          <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">
            Get in touch.
          </h2>
          <div className="mt-4 flex flex-col justify-between gap-10 sm:flex-row">
            <div>
              ...
              <address className="text-muted-foreground mt-2 text-base not-italic">
                <span className="flex items-center gap-2">
                  <MapPinIcon className="h-6 w-6" aria-hidden="true" /> 174
                  Adams St.
                </span>
                <span className="ml-8">Newton</span>, <span>MA</span>{" "}
                <span>02458</span>
              </address>
            </div>
            <div>
              ...
              <a
                ...
                className="text-muted-foreground hover:text-palette-primary-500 mt-2 flex items-center gap-2 text-base"
          ...
          <ul className="mt-2 flex flex-wrap items-center gap-6">
            {social.map((item, i) => {
              return (
                <li key={item.name}>
                  <a
                    className="text-muted-foreground hover:text-palette-primary-500 group relative inline-block transition-all duration-150 ease-in"
                    href={item.href}
                    title={item.name}
                    target="_blank"
                  ...
                  >
                    ...
                    <item.icon
                      ...
                      aria-hidden="true"
                    />
                    <span className="bg-muted-foreground invisible absolute bottom-10 z-10 scale-0 rounded-xl px-2 py-1 text-xs text-white transition-all group-hover:visible group-hover:scale-100">
                      {item.name}
                    </span>
                  </a>
                </li>
