    ...
    <>
      ...
      <div className="relative rounded-md">
        ...
        <input
          ...
          maxLength="5"
          className={clsx(
            "relative mt-1 w-full rounded-md border-0 bg-slate-100 py-2 pr-3 pl-10 text-base font-normal placeholder:text-slate-400 focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none sm:text-sm",
            {
              "text-slate-400": field.value === "",
