    ...
    <>
      ...
      <div className="relative rounded-md">
        ...
        <input
          ...
          // className={clsx(
          //   'mt-1 block w-full rounded-md border-0 bg-slate-100 placeholder:text-slate-400 py-2 pl-3 pr-3 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm',
          //   {
