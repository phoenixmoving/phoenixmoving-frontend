    ...
    <div className="mt-6 p-1">
      ...
      <dl className="divide-y divide-gray-200 mt-2">
        ...
        <div className="py-2 grid grid-cols-2 gap-4  items-center">
          ...
          <dd className="text-xs font-medium text-gray-700 flex items-end">
            {values.travelTime[0]}/{values.travelTime[1]} mins.
            <span className="text-gray-500 hover:text-palette-primary-500 transition-all duration-150 ease-in relative inline-block group">
              <svg
              ...
              <span className="invisible group-hover:visible w-[200px] absolute right-0 bottom-6 bg-gray-100 rounded-xl py-1 px-2 text-xs text-white z-10">
