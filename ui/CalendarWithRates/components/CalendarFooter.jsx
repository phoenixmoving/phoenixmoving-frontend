...
const InfoBox = ({ color, rates, type }) => {
  ...
  return (
    <div className="transition-all duration-150 ease-in relative inline-block group cursor-pointer">
      ...
      <div className="invisible group-hover:visible w-[200px] absolute -right-12 bottom-6 rounded-xl p-3 text-gray-700 bg-gray-50 z-10 shadow-3xl scale-0 transition-all group-hover:scale-100">
...
export default function CalendarFooter({ prices }) {
  ...
  return (
    <div className="border-t border-gray-900/5 flex items-center justify-between pt-4 text-xs font-semibold rounded-b-xl">
