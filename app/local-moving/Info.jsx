  ...
  return (
    <Section>
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-blue relative z-10 mx-auto max-w-prose lg:mx-0 lg:max-w-5xl lg:pr-72">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-8">
          ...
          <div className="relative mx-auto mt-12 mb-7 h-120 w-full max-w-prose lg:mt-0 lg:mb-0 lg:h-full lg:w-[80%]">
            <Image
              src={img}
              placeholder="blur"
              blurDataURL={img.blurDataURL}
              alt="Two movers packing dishes"
              className="rotate-2 rounded-2xl bg-white object-cover"
